...
-- Thời gian đã tạo: Th7 21, 2023 lúc 11:16 PM
...
--
-- Cơ sở dữ liệu: `ycdcdxmt_chat`
--
CREATE DATABASE IF NOT EXISTS `ycdcdxmt_chat` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ycdcdxmt_chat`;
...
(1, 274320927, 187277119, 'anh yÃªu em'),
(2, 187277119, 758274283, 'nháº¯n cc'),
(3, 758274283, 187277119, 'Ä‘á»‹t máº¹ mÃ y'),
(4, 758274283, 187277119, 'thÃ­ch lÃ m sÃ©c'),
(5, 187277119, 758274283, 'nháº¯n tin vá»›i bá»“ nhÃ­ Ä‘Æ°á»£c'),
(6, 187277119, 758274283, '=))'),
(7, 758274283, 187277119, 'hehhe'),
(8, 187277119, 758274283, 'chá»‰ lÃ m cÃ¡i sv Ä‘i'),
(9, 187277119, 758274283, 'code t tá»± code Ä‘c'),
(10, 448490541, 187277119, 'iu tom nhá»©t'),
(11, 187277119, 448490541, 'cac'),
(12, 448490541, 187277119, 'nhÆ°á»ng Ä‘Ãª'),
(13, 187277119, 448490541, 'cÃ³ cÃ¡i ce ce');
...
(1, 187277119, 'Do', 'Minh Tri', 'tricoder.net@gmail.com', 'd7e1e3109b5a3c2fb9fb2f5159c05d7c', '1687930834áº¢nh chá»¥p mÃ n hÃ¬nh 2023-06-27 080114.png', 'Active now'),
(4, 758274283, 'Pháº¡m', 'Khang', 'kayyone.ct247@gmail.com', '2ae0e9d7edd159c945f3236b558e75ac', '1687970523118307574_615918745985323_6845020785646655741_n.jpg', 'Active now'),
(5, 448490541, 'Tuan', 'Anhh', 'tuananh@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1687970726353054495_794334329035043_4533580162836914252_n.jpg', 'Active now'),
(6, 1389500856, 'cong', 'don', 'abcyxz@gmaicomlm.com', 'a1829696771ab348921475948866213b', '1687970764inbound6381893717374469679.jpg', 'Active now');
...
--
CREATE DATABASE IF NOT EXISTS `ycdcdxmt_shop` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ycdcdxmt_shop`;
...
(3, 'thongbao', ''),
(4, 'logo_light', 'assets/storage/images/logo_light_M3K.png'),
(5, 'logo_dark', 'assets/storage/images/logo_dark_XCG.png'),
(6, 'image', 'assets/storage/images/image_2AG.png'),
(7, 'favicon', 'assets/storage/images/favicon_WBO.png'),
...
(34, 'bg_login', 'assets/storage/images/bg_loginR1E.png'),
(35, 'bg_register', 'assets/storage/images/bg_registerDGJ.png'),
(36, 'time_cron_24h', '0'),
(37, 'status_demo', '0'),
...
(43, 'recharge_notice', ''),
(44, 'contact_page', ''),
(45, 'gif_loading', 'assets/storage/images/gif_loadingS02.png'),
...
(79, 'gif_loader', 'assets/storage/images/gif_loader35W.png'),
...
(1, 'tricoder', 'd3750729c391b853617aecd0ad229b91', 'tricoder.net@gmail.com', NULL, NULL, 1, 0, 0, 0, 0, '2023-07-21 21:40:24', '2023-07-21 21:40:24', 1689953710, 0, '116.97.106.244', 'd00e0c8e306f500d799588011ce28454', 0, 0, 0, NULL, 'Male', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36', NULL, 0, 'VYANR2H4RLQGD3XL', 0, 0, 0, 0, 0, 0, 0, 0, 1, NULL, 0);
...
ALTER TABLE `withdraw_ref`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- Cơ sở dữ liệu: `ycdcdxmt_traffic`
--
CREATE DATABASE IF NOT EXISTS `ycdcdxmt_traffic` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ycdcdxmt_traffic`;
...
CREATE TABLE `traffic` (
  ...
  `sl` varchar(999) NOT NULL,
  `datang` varchar(999) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
