                            ...
                            <div class="col-sm-12 mb-3">
                                <form action="" name="formSearch" method="GET">
                                    ...
                                    <div class="row">
                                        ...
                                        <input class="form-control col-sm-2 mb-2" value="<?=$account;?>" name="account"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                ...
                                                <li>Email: <b><?=getRowRealtime("users", $row['seller'], "email");?></b>
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
                                            <ul>
                                                ...
                                                <li>Email: <b><?=getRowRealtime("users", $row['buyer'], "email");?></b>
                                                </li>
                                            </ul>
                                        </td>
                                        <td>
