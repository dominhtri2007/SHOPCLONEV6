        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item"><a
                            href="<?=BASE_URL('client/privacy-policy');?>"><?=__('Chính sách bảo mật');?></a></li>
                    <li class="list-inline-item"><a
                            href="<?=BASE_URL('client/terms');?>"><?=__('Điều khoản sử dụng');?></a></li>
                </ul>
            </div>
            <div class="col-lg-6 text-right">
                <span class="mr-1">
                    ...
                    <?=__('Version');?> <b
                        style="color: red;"><?=$config['version'];?></b> | <?=$CMSNT->site('copyright_footer');?>
                </span>
            </div>
        </div>
    </div>
